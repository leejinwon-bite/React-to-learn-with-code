...
public interface CartItemRepository extends JpaRepository<CartItem, Long>{
  @Query("select " +
    "new org.zerock.mallapi.dto.CartItemListDTO(" +
  ...
  public List<CartItemListDTO> getItemsOfCartDTOByEmail(@Param("email")
    String email);
  ...
  public List<CartItemListDTO> getItemsOfCartDTOByCart(@Param("cno")
    Long cno);
}
